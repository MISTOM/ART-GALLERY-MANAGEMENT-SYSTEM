   ...
   <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="nav nav-tabs ml-auto my-2 my-lg-0" role="tablist">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle js-scroll-trigger text-warning disabled" data-toggle="dropdown" href="">View art</a>
      ...
      <div class="sidenav bg">
         <div class="login-main-text">
            <h1 class="display-4">Register<br></h1>
            <p class="text-dark"> Register here to continue.</p>
         </div>
      </div>
      <div class="main">
            ...
            <div class="login-form">
               <form action="register.php" method="POST" name="frm1">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="lastame" name="lname"required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="legendjohnny" name="uname" required>
                  </div>
                  <div class="form-group">
                     <label class="col-form-label">Password</label>
                     <input type="text" class="form-control" placeholder="newPassword" name="pword" required>
                  </div>
                  <div class="form-group">
                     <label class="col-form-label">Email</label>
                     <input type="email" class="form-control" placeholder="johnlegend@gmail.com" aria-describedby="emailHelp" required="required" name="email">
                  </div>
